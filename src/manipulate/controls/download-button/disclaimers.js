 ...
 *
 * From @ebi-gene-expression-group/expression-atlas-disclaimers 1.4.0, src/disclaimers.js
 * (https://github.com/ebi-gene-expression-group/atlas-web-bulk, app/src/main/javascript/modules/
 * expression-atlas-disclaimers), copied unchanged apart from this header and the linkTarget of the web links (the modal
 * renders in a portal, where the iframe's <base target=_parent> used to apply).
 */
import React from 'react'
import {linkAttrs} from '../../../layout/links.js'

const BlueprintDisclaimer = ({linkTarget}) =>
  <div>
    ...
    <p>
      ...
      who contributed to the generation of the data is available from <a {...linkAttrs(linkTarget)} href={`http://www.blueprint-epigenome.eu`}>
...
const FortLauderdaleDisclaimer = ({linkTarget}) =>
  <div>
    <h3>Fort Lauderdale Data Reuse Statement</h3>
    <p>
      This is a pre-publication release in accordance with <a {...linkAttrs(linkTarget)} href={`http://www.sanger.ac.uk/datasharing/`}>
    ...
    <p>
      ...
      site (<a {...linkAttrs(linkTarget)} href={`https://www.ebi.ac.uk/gxa/experiments/E-ERAD-475`}>
