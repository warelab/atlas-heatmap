...
import {heatmapFileName, heatmapIsEmpty, heatmapJson, heatmapSummary, heatmapTsv} from './Download.js'
...
// A disclaimer is shown in the dialog, and must be agreed to before either. When the heatmap shows no data, the dialog
// says so and saves nothing (the full data link stays).
const DownloadButton = ({
  ...
  return (
    <DownloadDialogButton
      ...
      nothingToSave={heatmapIsEmpty(heatmapData)}
